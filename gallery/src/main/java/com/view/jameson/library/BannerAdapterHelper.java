...
public class BannerAdapterHelper {
    public int sPagePadding = 6;
    public int sShowLeftCardWidth = 12;

    public BannerAdapterHelper(int sPagePadding, int sShowLeftCardWidth) {
        this.sPagePadding = sPagePadding;
        this.sShowLeftCardWidth = sShowLeftCardWidth;
    }
