...
public class BannerScaleHelper {
    ...
    private int mPagePadding; // 卡片的padding, 卡片间的距离等于2倍的mPagePadding
    ...
    public BannerScaleHelper(int pagePadding, int showLeftCardWidth) {
    ...
    private void onScrolledChangedCallback() {
        ...
        LogUtils.i("onScrolledChangedCallback >> leftPos:" + ((currentItemPos - 1) % 3) + " centerPos:" + ((currentItemPos) % 3) + "   rightPos:" + ((currentItemPos + 1) % 3));
    }
