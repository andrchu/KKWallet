...
public class ContactDao extends AbstractDao<Contact, Long> {
    ...
    */
    public static class Properties {
        ...
        public final static Property Surname = new Property(1, String.class, "surname", false, "SURNAME");
        public final static Property Name = new Property(2, String.class, "name", false, "NAME");
        public final static Property Address = new Property(3, String.class, "address", false, "ADDRESS");
        public final static Property Memo = new Property(4, String.class, "memo", false, "MEMO");
        public final static Property Chain_type = new Property(5, int.class, "chain_type", false, "CHAIN_TYPE");
    };
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"CONTACT\" (" + //
                ...
                "\"SURNAME\" TEXT," + // 1: surname
                "\"NAME\" TEXT," + // 2: name
                "\"ADDRESS\" TEXT," + // 3: address
                "\"MEMO\" TEXT," + // 4: memo
                "\"CHAIN_TYPE\" INTEGER NOT NULL );"); // 5: chain_type
    }
    ...
    protected final void bindValues(DatabaseStatement stmt, Contact entity) {
        ...
        stmt.bindLong(6, entity.getChain_type());
    }
    ...
    public Contact readEntity(Cursor cursor, int offset) {
        Contact entity = new Contact( //
            ...
            cursor.isNull(offset + 1) ? null : cursor.getString(offset + 1), // surname
            cursor.isNull(offset + 2) ? null : cursor.getString(offset + 2), // name
            cursor.isNull(offset + 3) ? null : cursor.getString(offset + 3), // address
            cursor.isNull(offset + 4) ? null : cursor.getString(offset + 4), // memo
            cursor.getInt(offset + 5) // chain_type
        );
        return entity;
    }
    ...
    public void readEntity(Cursor cursor, Contact entity, int offset) {
        ...
        entity.setSurname(cursor.isNull(offset + 1) ? null : cursor.getString(offset + 1));
        entity.setName(cursor.isNull(offset + 2) ? null : cursor.getString(offset + 2));
        entity.setAddress(cursor.isNull(offset + 3) ? null : cursor.getString(offset + 3));
        entity.setMemo(cursor.isNull(offset + 4) ? null : cursor.getString(offset + 4));
        entity.setChain_type(cursor.getInt(offset + 5));
     }
