...
public class DaoMaster extends AbstractDaoMaster {
    ...
    public static void createAllTables(Database db, boolean ifNotExists) {
        ...
        CardPkgDao.createTable(db, ifNotExists);
        ContactDao.createTable(db, ifNotExists);
        PushMessageDao.createTable(db, ifNotExists);
        SelectTokenDao.createTable(db, ifNotExists);
    ...
    public static void dropAllTables(Database db, boolean ifExists) {
        ...
        CardPkgDao.dropTable(db, ifExists);
        ContactDao.dropTable(db, ifExists);
        PushMessageDao.dropTable(db, ifExists);
        SelectTokenDao.dropTable(db, ifExists);
    ...
    public DaoMaster(Database db) {
        ...
        registerDaoClass(CardPkgDao.class);
        registerDaoClass(ContactDao.class);
        registerDaoClass(PushMessageDao.class);
        registerDaoClass(SelectTokenDao.class);
