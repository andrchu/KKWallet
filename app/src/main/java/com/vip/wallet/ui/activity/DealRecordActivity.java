...
import com.vip.wallet.ui.fragment.DealRecordFragment;

/**
 * 创建者     金国栋
 * 创建时间   2018/5/28 0028 19:04
 * 描述	      ${TODO}
 */
...
public class DealRecordActivity extends BaseActivity {
    ...
    public void onEnterAnimationComplete() {
        ...
        if (findFragment(DealRecordFragment.class) == null) {
            loadRootFragment(R.id.adr_container, DealRecordFragment.newInstance());
        }
    }
