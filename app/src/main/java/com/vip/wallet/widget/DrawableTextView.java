...
public class DrawableTextView extends AppCompatTextView {
    ...
    public DrawableTextView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        widths[0] = array.getDimensionPixelSize(R.styleable.DrawableTextView_leftDrawableWidth, drawables[0] == null ? 0 : drawables[0].getIntrinsicWidth());
        widths[1] = array.getDimensionPixelSize(R.styleable.DrawableTextView_topDrawableWidth, drawables[1] == null ? 0 : drawables[1].getIntrinsicWidth());
        widths[2] = array.getDimensionPixelSize(R.styleable.DrawableTextView_rightDrawableWidth, drawables[2] == null ? 0 : drawables[2].getIntrinsicWidth());
        widths[3] = array.getDimensionPixelSize(R.styleable.DrawableTextView_bottomDrawableWidth, drawables[3] == null ? 0 : drawables[3].getIntrinsicWidth());

        heights[0] = array.getDimensionPixelSize(R.styleable.DrawableTextView_leftDrawableHeight, drawables[0] == null ? 0 : drawables[0].getIntrinsicHeight());
        heights[1] = array.getDimensionPixelSize(R.styleable.DrawableTextView_topDrawableHeight, drawables[1] == null ? 0 : drawables[1].getIntrinsicHeight());
        heights[2] = array.getDimensionPixelSize(R.styleable.DrawableTextView_rightDrawableHeight, drawables[2] == null ? 0 : drawables[2].getIntrinsicHeight());
        heights[3] = array.getDimensionPixelSize(R.styleable.DrawableTextView_bottomDrawableHeight, drawables[3] == null ? 0 : drawables[3].getIntrinsicHeight());
